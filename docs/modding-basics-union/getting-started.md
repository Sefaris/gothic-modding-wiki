...
:::tip
To skip manual copying, you can create a **symbolic link** from the output directory to your game's `Autorun` folder. This way the DLL is available immediately after each build.
:::
